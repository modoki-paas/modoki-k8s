...
func (OperateKind) EnumDescriptor() ([]byte, []int) { return fileDescriptor1, []int{0} }
...
func (*KubernetesConfig) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{0} }
...
func (*YAML) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{1} }
...
func (*OperateRequest) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{2} }
...
func (*OperateResponse) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{3} }
...
func (*MetricsRequest) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{4} }
...
func (*MetricsResponse) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{5} }
...
func init() { proto.RegisterFile("generator.proto", fileDescriptor1) }
